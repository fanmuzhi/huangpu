...
const int LJM_READ = 0;
const int LJM_WRITE = 1;

// Data Types:
// These do automatic endianness conversion, if needed by the local machine's
// processor.
const int LJM_UINT16 = 0; // C type of unsigned short
const int LJM_UINT32 = 1; // C type of unsigned int
const int LJM_INT32 = 2; // C type of int
const int LJM_FLOAT32 = 3; // C type of float

// Advanced users data types:
//     These do not do any endianness conversion.
const int LJM_BYTE = 99; // Contiguous bytes. If the number of LJM_BYTEs is
...
const int LJM_STRING = 98; // Same as LJM_BYTE, but LJM automatically appends
                           // a null-terminator.

const unsigned int LJM_STRING_MAX_SIZE = 49;
...
const int LJM_INVALID_NAME_ADDRESS = -1;
...
// Device types:
const int LJM_dtANY = 0;
const int LJM_dtUE9 = 9;
const int LJM_dtU3 = 3;
const int LJM_dtU6 = 6;
const int LJM_dtT7 = 7;
const int LJM_dtSKYMOTE_BRIDGE = 1000;
const int LJM_dtDIGIT = 200;

// Connection types:
const int LJM_ctANY = 0;
const int LJM_ctUSB = 1;
const int LJM_ctTCP = 2;
const int LJM_ctETHERNET = 3;
const int LJM_ctWIFI = 4;

// TCP/Ethernet constants:
const int LJM_NO_IP_ADDRESS = 0;
const int LJM_NO_PORT = 0;
const int LJM_DEFAULT_PORT = 502;

// Identifier types:
const char * const LJM_DEMO_MODE = "-1";
const int LJM_idANY = 0;

// LJM_AddressesToMBFB Constants
enum { LJM_DEFAULT_FEEDBACK_ALLOCATION_SIZE = 62 };
const int LJM_USE_DEFAULT_MAXBYTESPERMBFB = 0;

// LJM_MBFBComm Constants;
const int LJM_DEFAULT_UNIT_ID = 1;
...
const int LJM_MAX_USB_PACKET_NUM_BYTES = 64;
const int LJM_MAX_TCP_PACKET_NUM_BYTES_T7 = 1040;
const int LJM_MAX_TCP_PACKET_NUM_BYTES_NON_T7 = 64; // This may change

// Timeout Constants
const int LJM_NO_TIMEOUT = 0;
const int LJM_DEFAULT_TIMEOUT = 20000; // Send/Receive timeout in milliseconds

// Stream Constants
const int LJM_DUMMY_VALUE = -9999;
const int LJM_GND = 199;
...
LJM_ERROR_CODE LJME_DEVICE_RECONNECT_FAILED = 1239;
 ...
 *           LJM_dtU3, etc.). LJM_dtANY is allowed.
...
const long LJM_ttB = 6001;
const long LJM_ttE = 6002;
const long LJM_ttJ = 6003;
const long LJM_ttK = 6004;
const long LJM_ttN = 6005;
const long LJM_ttR = 6006;
const long LJM_ttS = 6007;
const long LJM_ttT = 6008;
...
/**
 * Name: LJM_SEND_RECEIVE_TIMEOUT_MS
...
**/
const char * const LJM_DEBUG_LOG_MODE = "LJM_DEBUG_LOG_MODE";

	const double LJM_DEBUG_LOG_MODE_NEVER = 1;
	const double LJM_DEBUG_LOG_MODE_CONTINUOUS = 2;
	const double LJM_DEBUG_LOG_MODE_ON_ERROR = 3;
...
**/
const char * const LJM_DEBUG_LOG_LEVEL = "LJM_DEBUG_LOG_LEVEL";

	const double LJM_STREAM_PACKET = 1;
	const double LJM_TRACE = 2;
	const double LJM_DEBUG = 4;
	const double LJM_INFO = 6;
	const double LJM_PACKET = 7;
	const double LJM_WARNING = 8;
	const double LJM_USER = 9;
	const double LJM_ERROR = 10;
	const double LJM_FATAL = 12;

/**
 * Name: LJM_DEBUG_LOG_BUFFER_MAX_SIZE
 * Desc: The number of log messages LJM's logger buffer can hold.
**/
const char * const LJM_DEBUG_LOG_BUFFER_MAX_SIZE = "LJM_DEBUG_LOG_BUFFER_MAX_SIZE";
...
**/
const char * const LJM_DEBUG_LOG_SLEEP_TIME_MS = "LJM_DEBUG_LOG_SLEEP_TIME_MS";
...
**/
const char * const LJM_LIBRARY_VERSION = "LJM_LIBRARY_VERSION";
...
**/
const char * const LJM_ALLOWS_AUTO_MULTIPLE_FEEDBACKS = "LJM_ALLOWS_AUTO_MULTIPLE_FEEDBACKS";
 ...
 *       Anything else - Enable (default)
**/
const char * const LJM_ALLOWS_AUTO_CONDENSE_ADDRESSES = "LJM_ALLOWS_AUTO_CONDENSE_ADDRESSES";
...
**/
const char * const LJM_OPEN_MODE = "LJM_OPEN_MODE";
...
**/
const char * const LJM_MODBUS_MAP_CONSTANTS_FILE = "LJM_MODBUS_MAP_CONSTANTS_FILE";
 ...
 *       LJM_ErrorToString.
**/
const char * const LJM_ERROR_CONSTANTS_FILE = "LJM_ERROR_CONSTANTS_FILE";
...
**/
const char * const LJM_DEBUG_LOG_FILE = "LJM_DEBUG_LOG_FILE";
...
**/
const char * const LJM_CONSTANTS_FILE = "LJM_CONSTANTS_FILE";
...
**/
const char * const LJM_DEBUG_LOG_FILE_MAX_SIZE = "LJM_DEBUG_LOG_FILE_MAX_SIZE";
...
**/
const char * const LJM_STREAM_TRANSFERS_PER_SECOND = "LJM_STREAM_TRANSFERS_PER_SECOND";
 ...
 *       1 - Enable (default)
**/
const char * const LJM_RETRY_ON_TRANSACTION_ID_MISMATCH = "LJM_RETRY_ON_TRANSACTION_ID_MISMATCH";
...
**/
const char * const LJM_OLD_FIRMWARE_CHECK = "LJM_OLD_FIRMWARE_CHECK";
