...
const long LJ_ioSET_STREAM_CALLBACK_PTR = 260; // This is for 64-bit compatibility.  The tStreamCallback function is passed as X1 and channel is the User Variable
...
3.38: Added AddRequestPtr, ePutPtr and LJ_ioSET_STREAM_CALLBACK_PTR for better 64-bit compatibility
