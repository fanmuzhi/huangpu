...
void Ts_CurrentTest::Execute()
{
	...
	try
	{
		...
		//site.m_currentInfo.m_arImageAcqCurrentVals[ADC4] = arCurrentSums[ADC4] / NUM_CURRENT_DRAW_READINGS;
		...
		//site.m_currentInfo.m_arImageAcqCurrentVals[ADC1] = arCurrentSums[ADC1] / NUM_CURRENT_DRAW_READINGS;
	}
